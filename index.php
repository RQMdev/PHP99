  ...
  <body>
    ...
    <section class="section1 is-showing">
      ...
      <?php
        ...
        print "<pre>";
        print_r(commander($viandes, $cuissons));
        print "</pre>";
    ...
    <section class="section4">
      ...
      <?php
        ...
        print "<pre>";
        print_r(chooseYourSide($prenoms));
        print "</pre>";
    ...
    <section class="section6">
      ...
      <?php
        ...
        print "<pre>";
        print_r(convertToInternational($portables));
        print "</pre>";
    ...
    <section class="section7">
      ...
      <?php
        ...
        print "Il y a ";
        print_r(howManyHThereIs($sadisme));
